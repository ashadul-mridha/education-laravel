              ...
              <form action="{{ route('subscription.update')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="number" class="form-control" value="{{ $data->price }}" name="price" placeholder="Enter Price:">
                        @error('price')
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="number" class="form-control" value="{{ $data->discount_price }}" name="discount" placeholder="Enter Discount Price:">
                        @error('discount')
                        <strong class="text-danger">{{ $message }} </strong>
                        @enderror  
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select class="form-control" name="active" id="active">
                            <option value="active" {{$data->active == 'active' ? 'selected' : ' '}}>Active</option>
                            <option value="inactive"{{$data->active == 'inactive' ? 'selected' : ' '}}>Inactive</option>
                        </select>
                        @error('active')
                        <strong class="text-danger">{{ $message }} </strong>
                        @enderror  
