      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{ route('exam.store') }}" method="POST" id="myform">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <label class="text-info" for="exam_title">Exam Title</label>
                        <input type="text" class="form-control" name="exam_title" id="exam_title" placeholder="Enter Your Exam Title:">
                        @error('exam_title')
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="date" class="form-control" name="exam_start_date" id="exam_start_date" placeholder="Enter Your Exam Start date:">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control" name="exam_start_time" id="exam_start_time" placeholder="Enter Your Exam Start Time:">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control" name="exam_end_time" id="exam_end_time" placeholder="Enter Your Exam End Time:">
                        @error('exam_end_time')
                        <strong class="text-danger">{{ $message }} </strong>
                        @enderror  
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" name="exam_description" id="exam_description" rows="4"></textarea>
