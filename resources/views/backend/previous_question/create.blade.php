      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="{{ route('pre_ques.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <label class="text-info" for="question_title">Question Title</label>
                        <input type="text" class="form-control" value="{{ old('question_title')}}" name="question_title"  placeholder="Enter Your Exam Title:">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="date" class="form-control" value="{{ old('question_year')}}" name="question_year" placeholder="Enter Your Exam Right Answare:">
                        @error('question_year')
                        <strong class="text-danger">{{ $message }} </strong>
                        @enderror  
                    </div>
